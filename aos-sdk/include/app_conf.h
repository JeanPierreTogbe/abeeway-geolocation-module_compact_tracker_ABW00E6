...
/*!
 * \defgroup app_conf Application configuration file for STM32WPAN Middleware
 *
 * \addtogroup app_conf
 * @{
 */
...
#define CFG_BLE_MIN_TX_POWER            (0)     //!< Minimum transmit power in dBm supported by the Controller

#define CFG_BLE_MAX_TX_POWER            (0)     //!< Maximum transmit power in dBm supported by the Controller
